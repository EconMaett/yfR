...
# - All inputs are now formatted as snake_case instead of dot.case.
...
#   S&P 500 index, simply call yfR::yf_collection_get("SP500")

# - All functions have been renamed for a common API notation.
#   For example, BatchGetSymbols::BatchGetSymbols() 
#   is now yfR::yf_get()
...
#   attribute of the output with base::attributes()

# - New and prettier status messages through  the cli package.
